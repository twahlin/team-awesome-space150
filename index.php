...
<head>
    ...
    <script src="public/scripts/jquery.scrollto.js" type="text/javascript" charset="utf-8"></script>	  
    <script type="text/javascript" src="http://use.typekit.com/nmv5yni.js"></script>
...
<section class="wave-module">
  <div class="section_wrap">
    ...
    <div class="wave_set">
      ...
      <div id="waves_2" class="waves waves_2"></div>
      <div id="waves_3" class="waves waves_3"></div>
      <div id="waves_4" class="waves waves_4"></div>
      <div id="waves_5" class="waves waves_5"></div>
